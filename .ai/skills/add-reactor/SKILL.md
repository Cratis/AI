...
> **Always read the [reactors.md](https://github.com/Cratis/AI/blob/main/.ai/rules/reactors.md) rule first.** It is the source of truth for reactor conventions, rules, and patterns.
