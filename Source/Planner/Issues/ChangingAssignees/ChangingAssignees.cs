...
/// <summary>
/// Command for changing the assignees of an issue - mirroring assignment on GitHub. The full
/// assignee set travels as one fact; every issue webhook delivery carries the resulting set,
/// regardless of which action triggered it.
/// </summary>
/// <param name="Issue">The identity of the issue.</param>
/// <param name="Assignees">The logins of the users the issue is now assigned to.</param>
[Command]
