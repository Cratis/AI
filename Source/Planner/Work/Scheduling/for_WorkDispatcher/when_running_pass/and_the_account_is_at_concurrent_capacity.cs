...
public class and_the_account_is_at_concurrent_capacity : given.all_dependencies
{
    void Establish()
    {
        ...
        _workItemsData.Add(new WorkItem(WorkId.New(), WorkPurpose.Implementation, [new IssueId("cratis-studio-1")], ModelName.NotSet, WorkStatus.Running, account.Id, _now.AddMinutes(-10)));
