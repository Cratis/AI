...
public class and_the_provider_is_not_configured : Specification
{
    ...
    async Task Because() =>
        _result = await new ReconfigureAnthropicProvider(AIProviderId.New(), new AIProviderName("Renamed"), new AIProviderApiKey("sk-ant-new"))
            .Handle(null, Substitute.For<ISecretProtector>());
