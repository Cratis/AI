...
const defaultConfig = [
    {
        ignores: [
            ...
            '**/Api/**',
            '**/rollup.config.mjs',
            // Generated proxy trees (e.g. Source/Cratis.AI.Proxies/generated) carry their own
            // "@generated by Cratis" header rather than the MIT one, and are never hand-edited -
            // the CI drift gate in publish.yml (git diff after a fresh dotnet build) is what keeps
            // them honest, not lint.
            '**/generated/**'
        ],
    },
    {
