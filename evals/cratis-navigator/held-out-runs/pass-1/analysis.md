...
The pilot matched all ten held-out decisions and semantic fields. Eight outputs
strictly matched the frozen JSON. H05 and H10 used different non-empty
clarification wording than the frozen gold. That wording is allowed semantically
but is not strict equality, so the 95% strict held-out threshold is not met.
