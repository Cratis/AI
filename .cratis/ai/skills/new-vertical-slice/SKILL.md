...
- The owning repository's local documentation gate passes when present; `cd ../Documentation/web && npm run check` passes when documentation is added or changed and the sibling Documentation checkout is available
