...
verification workflow. That workflow remains authored and reviewed in
`Cratis/AI`, is installed through a bot-authored pull request, stays outside
package manifests and checksums, and is preserved when generated payload bytes
are replaced. It does not make `AI.Distribution` an authoring repository, and
humans still do not patch either the workflow or generated artifacts in place.
