...
| Generated package bytes | `Cratis/AI` at the protected `distribution` ref | Host package, manifest, checksum, provenance, native projection, tagged `dist/vX.Y.Z` |
