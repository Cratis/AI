...
const rules = {
    ...
    ...{
        ...
        // Generated command proxies for property-less commands emit an empty
        // interface; this is the renamed successor of the already-disabled no-empty-interface rule.
