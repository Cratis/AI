...
export function validateSources(catalogs, root) {
    ...
    if (!equalStringSets(sourceIds, v1Ids))
        errors.push(
            "catalog v2 sources must preserve all 56 authored skill sources exactly once",
        );
    if (sourceIds.length !== 56)
        errors.push(
            `catalog v2 must contain 56 sources; found ${sourceIds.length}`,
        );
