...
const inventoryDefinitions = () => [
    ...
    },
    {
        ...
        excludePathPatterns: [
            ...
            "skills/cratis-studio-mcp-safety-guidance/references/**",
        ],
    ...
    {
        id: "mcp-generated-guidance-references",
        sourcePathPatterns: [
            "skills/cratis-chronicle-mcp-inspection/references/**",
            "skills/cratis-studio-mcp-safety-guidance/references/**",
        ],
        ...
        generator: "tooling/generate-mcp-guidance-references.mjs",
    },
    {
    ...
    },
    {
        ...
        sourcePathPatterns: [
            ...
            "Documentation/studio-mcp-guidance.md",
        ],
        artifactType: "documentation",
        currentOwner: repositoryOwner,
        targetOwner: repositoryOwner,
    ...
    },
    {
        ...
        sourcePathPatterns: [
            ...
            "catalog/evidence-baseline.schema.json",
            "catalog/evidence.json",
            ...
            "catalog/schemas/release-readiness.schema.json",
    ...
    {
        id: "s10-release-readiness",
        sourcePathPatterns: ["catalog/v2/release-readiness.json"],
        artifactType: "catalog-schema",
        currentOwner: repositoryOwner,
        targetOwner: repositoryOwner,
        runtimeEligibility: "repository-only",
        ...
        migrationState: "retain",
        evidenceIds: ["option-a-plus-authority"],
        generator: "tooling/generate-release-readiness.mjs",
    },
    {
    ...
    {
        id: "s8-native-non-skill-expected-tree",
        sourcePathPatterns: [
            "tooling/fixtures/s8-native-non-skill-expected-tree.json",
        ],
        ...
        migrationState: "retain",
        evidenceIds: ["reevaluation-authority"],
        generator: "tooling/native-non-skill-projections.mjs",
    },
    {
