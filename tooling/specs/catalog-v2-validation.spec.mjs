...
test("catalog v2 preserves all 57 sources while split and merge targets are independent", () => {
    const catalogs = loadCatalogs();
    assert.equal(catalogs.sources.sources.length, 57);
    assert.equal(catalogs.targets.targets.length, 57);
