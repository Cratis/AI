...
test("all 152 observations, 172 fact IDs, 11 legacy gaps, 108 official sources, and 17 distribution evidence files are accounted exactly", () => {
    ...
    assert.equal(catalogs.evidence.distributionEvidenceFiles.length, 17);
    assert.deepEqual(
